...
#   filename:  <stdin>
#   timestamp: 2025-08-11T15:40:19+00:00
...
class PCMUserMessageAudioConfig(BaseModel):
    ...
    n_channels: int = Field(..., gt=0, title='N Channels')
...
class GetSimulationUnitTestSetRunsParametersQuery(BaseModel):
    ...
    created_at_end_time: Optional[datetime] = Field(
        None,
