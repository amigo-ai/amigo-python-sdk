...
#   filename:  <stdin>
#   timestamp: 2026-02-22T15:20:08+00:00
...
class Input(BaseModel):
    ...
    nonsensitive_user_variables: dict[StrippedNonemptyStringAZAZ09, str] | None = Field(
        {},
...
class SimulationPersonaVersion(BaseModel):
    ...
    nonsensitive_user_variables: dict[str, str] | None = Field(
        {},
...
class ToolInvocationInstance(BaseModel):
    ...
    logs: list[str] | None = Field(
        [],
        description='The logs of the tool invocation. TODO: Remove after platform deprecation of this field. ',
        title='Logs',
    )
