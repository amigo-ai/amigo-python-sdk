...
#   filename:  <stdin>
#   timestamp: 2026-03-14T16:57:00+00:00
...
class StrippedNonemptyStringAZAZ09LambdaAt0xffff4a9e6f00(StrippedNonemptyStringAZAZ09):
    pass
...
class UserCreateInvitedUserRequest(BaseModel):
    ...
    nonsensitive_user_variables: (
        dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff4a9e6f00, str] | None
    ) = Field(
        default_factory=lambda: TypeAdapter(
            dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff4a9e6f00, str]
        ).validate_python({}),
        description='The nonsensitive user variables to provide to the tool during invocation.',
        title='Nonsensitive User Variables',
    )
