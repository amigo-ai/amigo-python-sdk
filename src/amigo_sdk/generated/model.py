...
#   filename:  <stdin>
#   timestamp: 2026-03-18T20:49:41+00:00
...
class LLMType(Enum):
    ...
    openai_gpt_5_1_2025_11_13 = 'openai_gpt-5.1-2025-11-13'
...
class StrippedNonemptyStringAZAZ09LambdaAt0xffff4c237480(StrippedNonemptyStringAZAZ09):
    pass
...
class ConversationCreateConversationRequest(BaseModel):
    ...
    tags: (
        ...
        default_factory=lambda: TypeAdapter(
            dict[
                StrippedNonemptyStringWS1,
                PydanticBaseModelStrippedNonemptyString4 | None,
            ]
        ).validate_python({}),
...
class ConversationModifyTagsOfConversationRequest(BaseModel):
    updates: dict[StrippedNonemptyStringWS, StrippedNonemptyStringWS | None] | None = (
        Field(
            default_factory=lambda: TypeAdapter(
                dict[StrippedNonemptyStringWS, StrippedNonemptyStringWS | None]
            ).validate_python({}),
...
class MetricUpdateMetricRequest(BaseModel):
    ...
    additional_notes: PydanticBaseModelStrippedNonemptyString1 | FieldNotSet | None = (
        Field(
            default_factory=lambda: TypeAdapter(
                PydanticBaseModelStrippedNonemptyString1 | FieldNotSet
            ).validate_python({}),
...
class SimulationCreateSimulationPersonaRequestInitialVersion(BaseModel):
    ...
    preferred_language: DefaultSpokenLanguage | FieldNotSet | None = Field(
        default_factory=lambda: TypeAdapter(
            DefaultSpokenLanguage | FieldNotSet
        ).validate_python({}),
    ...
    timezone: Timezone | FieldNotSet | None = Field(
        default_factory=lambda: TypeAdapter(Timezone | FieldNotSet).validate_python({}),
...
class OrganizationCreateOrganizationRequest(BaseModel):
    ...
    title: PydanticBaseModelStrippedNonemptyString1 = Field(
        ...,
        description='An advertising tagline for the services offered by this organization.',
    )
    main_description: PydanticBaseModelStrippedNonemptyString1 = Field(
        ...,
        description='A description of the services offered by this organization that is displayed on the login page for the Amigo frontend for this organization.',
    )
    sub_description: PydanticBaseModelStrippedNonemptyString1 = Field(
        ...,
        description='Additional descriptions of the services offered by this organization that is displayed below `main_description` in a smaller font.',
    )
...
class UserCreateInvitedUserRequest(BaseModel):
    ...
    nonsensitive_user_variables: (
        dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff4c237480, str] | None
    ) = Field(
        default_factory=lambda: TypeAdapter(
            dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff4c237480, str]
        ).validate_python({}),
        description='The nonsensitive user variables to provide to the tool during invocation.',
        title='Nonsensitive User Variables',
    )
    sensitive_user_variables: dict[StrippedNonemptyStringAZAZ09, str] | None = Field(
        default_factory=lambda: TypeAdapter(
            dict[StrippedNonemptyStringAZAZ09, str]
        ).validate_python({}),
        description='The sensitive user variables to provide to the tool during invocation.',
        title='Sensitive User Variables',
    )
