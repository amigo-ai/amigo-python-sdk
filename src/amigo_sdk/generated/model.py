...
#   filename:  <stdin>
#   timestamp: 2026-03-17T19:52:12+00:00
...
class StrippedNonemptyStringAZAZ09LambdaAt0xffff63df78a0(StrippedNonemptyStringAZAZ09):
    pass
...
class RoleCreateTemporaryPermissionGrantRequest(BaseModel):
    ...
    justification: PydanticBaseModelStrippedNonemptyString4 = Field(
...
class UserCreateInvitedUserRequest(BaseModel):
    ...
    nonsensitive_user_variables: (
        dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff63df78a0, str] | None
    ) = Field(
        default_factory=lambda: TypeAdapter(
            dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff63df78a0, str]
        ).validate_python({}),
        description='The nonsensitive user variables to provide to the tool during invocation.',
        title='Nonsensitive User Variables',
    )
