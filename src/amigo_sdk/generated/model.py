...
#   filename:  <stdin>
#   timestamp: 2026-03-18T17:17:48+00:00
...
class StrippedNonemptyStringAZAZ09LambdaAt0xffff72a0b530(StrippedNonemptyStringAZAZ09):
    pass
...
class UserCreateInvitedUserRequest(BaseModel):
    ...
    nonsensitive_user_variables: (
        dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff72a0b530, str] | None
    ) = Field(
        default_factory=lambda: TypeAdapter(
            dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff72a0b530, str]
        ).validate_python({}),
        description='The nonsensitive user variables to provide to the tool during invocation.',
        title='Nonsensitive User Variables',
    )
