...
#   filename:  <stdin>
#   timestamp: 2026-09-08T00:48:37+00:00
...
class NextState1(RootModel[tuple[str, str]]):
...
class AnnotationStateOutput(BaseModel):
    ...
    next_state: str | NextState1 = Field(
        ...,
        description="The state to transition to after the inner thought message is generated. If it's a string, the session will transition to a state within this contextual graph. If it's a tuple, the first element\nmust be of the form `{external_contextual_graph_reference_name}.{state_name}` and represents a state in another contextual graph that the session will transition to, and the second element must be a state\nin this contextual graph that the session will transition to after reaching the terminal state of the external graph.",
        title='Next State',
    )
...
class NextState3(RootModel[tuple[str, str]]):
    root: tuple[str, str] = Field(
        ...,
...
class ExitConditionOutput(BaseModel):
    ...
    next_state: str | NextState3 = Field(
        ...,
        description="The state to transition to if this exit condition is met. If it's a string, the session will transition to a state within this contextual graph. If it's a tuple, the first element\nmust be of the form `{external_contextual_graph_reference_name}.{state_name}` and represents a state in another contextual graph that the session will transition to, and the second element must be a state\nin this contextual graph that the session will transition to after reaching the terminal state of the external graph.",
        title='Next State',
    )
...
class FailedInvocationResult(BaseModel):
    succeeded: Literal[False] = Field(False, title='Succeeded')
...
class Input(BaseModel):
    ...
    nonsensitive_user_variables: dict[StrippedNonemptyStringAZAZ09, str] = Field(
        ...,
        description='The nonsensitive user variables to provide to the tool during invocation.',
        max_length=20,
        title='Nonsensitive User Variables',
    )
    sensitive_user_variables: dict[StrippedNonemptyStringAZAZ09, str] = Field(
        ...,
...
class LLMType(Enum):
    ...
    openai_gpt_5_4_nano_2026_03_17 = 'openai_gpt-5.4-nano-2026-03-17'
    openai_gpt_5_4_mini_2026_03_17 = 'openai_gpt-5.4-mini-2026-03-17'
    openai_gpt_5_5_2026_04_23 = 'openai_gpt-5.5-2026-04-23'
    openai_gpt_5_6_sol = 'openai_gpt-5.6-sol'
    openai_gpt_5_6_terra = 'openai_gpt-5.6-terra'
    openai_gpt_5_6_luna = 'openai_gpt-5.6-luna'
...
class NextState5(RootModel[tuple[str, str]]):
    root: tuple[str, str] = Field(
        ...,
...
class RecallStateOutput(BaseModel):
    ...
    next_state: str | NextState5 = Field(
        ...,
        description="The state to transition to after the active memory extraction is performed. If it's a string, the session will transition to a state within this contextual graph. If it's a tuple, the first element\nmust be of the form `{external_contextual_graph_reference_name}.{state_name}` and represents a state in another contextual graph that the session will transition to, and the second element must be a state\nin this contextual graph that the session will transition to after reaching the terminal state of the external graph.",
        title='Next State',
    )
...
class References(RootModel[tuple[str, int]]):
...
class StrippedNonemptyStringAZaZ09MaxLenMaxLength40(RootModel[str]):
...
class StrippedNonemptyStringWS1(RootModel[str]):
    root: str = Field(..., min_length=1, pattern='^[\\w\\s_]+$')


class StrippedNonemptyStringAZ1(RootModel[str]):
    root: str = Field(..., max_length=20, min_length=1, pattern='^[a-z-]+$')
...
class StrippedNonemptyStringAZAZ09(RootModel[str]):
    root: str = Field(..., min_length=1, pattern='^[a-z_][a-z0-9_]+$')


class StrippedNonemptyStringAZAZ09LambdaAt0xffff509bfcc0(StrippedNonemptyStringAZAZ09):
    pass
...
class NextState8(RootModel[tuple[ExternalStateName, StateOrRefName]]):
    root: tuple[ExternalStateName, StateOrRefName] = Field(
        ..., max_length=2, min_length=2, title='Next State'
    )


class NextState9(NextState1):
    pass
...
class UpsertRequest(BaseModel):
    name: StrippedNonemptyStringAZAZ09 = Field(
    ...
    is_secret: bool = Field(
        ..., description='Whether the variable is a secret.', title='Is Secret'
    )
...
class UserMessageAudioConfig(
    RootModel[MP3UserMessageAudioConfig | PCMUserMessageAudioConfig]
):
    root: MP3UserMessageAudioConfig | PCMUserMessageAudioConfig = Field(
        ..., discriminator='type'
    )
...
class VersionSetOutput(BaseModel):
    ...
    llm_model_preferences: dict[str, LLMConfigOutput] = Field(
        ...,
...
class WebhookType(Enum):
    conversation_post_processing_complete = 'conversation-post-processing-complete'
    api_key_expiration_soon = 'api-key-expiration-soon'
    agent_framework_resource_updated = 'agent-framework-resource-updated'
...
class MongoCollectionsAgentAgentUserInfo(BaseModel):
...
class MongoCollectionsDynamicBehaviorSetDynamicBehaviorSetUserInfo(
    MongoCollectionsAgentAgentUserInfo
):
    pass
...
class MongoCollectionsDynamicBehaviorSetVersionDynamicBehaviorSetVersionUserInfo(
    MongoCollectionsAgentAgentUserInfo
):
    pass


class MongoCollectionsMetricMetricUserInfo(MongoCollectionsAgentAgentUserInfo):
    pass
...
class MongoCollectionsMetricVersionMetricVersionUserInfo(
    MongoCollectionsAgentAgentUserInfo
):
    pass


class MongoCollectionsServiceServiceUserInfo(MongoCollectionsAgentAgentUserInfo):
    pass
...
class MongoCollectionsServiceHierarchicalStateMachineServiceHierarchicalStateMachineUserInfo(
    MongoCollectionsAgentAgentUserInfo
):
    pass
...
class MongoCollectionsSimulationPersonaVersionSimulationPersonaVersionUserInfo(
    MongoCollectionsAgentAgentUserInfo
):
    pass
...
class MongoCollectionsSimulationScenarioVersionSimulationScenarioVersionUserInfo(
    MongoCollectionsAgentAgentUserInfo
):
    pass
...
class MongoCollectionsSimulationUnitTestSetRunSimulationUnitTestSetRunUnitTestRunResultMetricEvaluationResult(
    ...
    metric_version: int = Field(..., title='Metric Version')
...
class MongoCollectionsToolToolUserInfo(MongoCollectionsAgentAgentUserInfo):
    pass
...
class PydanticBaseModelStrippedNonemptyString2(RootModel[str]):
...
class PydanticBaseModelStrippedNonemptyString4(RootModel[str]):
    root: str = Field(..., max_length=100, min_length=1)


class PydanticBaseModelStrippedNonemptyString5(RootModel[str]):
...
class AdminSubmitSqlQueryRequest(BaseModel):
    sql_query: PydanticBaseModelStrippedNonemptyString1 = Field(
...
class ConversationCreateConversationRequest(BaseModel):
    ...
    tags: (
        dict[StrippedNonemptyStringWS1, PydanticBaseModelStrippedNonemptyString4 | None]
        | None
    ) = Field(
        {},
        description='A list of tags for the conversation. The key can only contain alphanumeric characters, underscores, or spaces. The value can only contain up to 100 characters.',
        max_length=20,
        title='Tags',
...
class ConversationGenerateConversationStarterRequest(BaseModel):
    ...
    generation_instructions: PydanticBaseModelStrippedNonemptyString1 = Field(
...
class ConversationRecommendResponsesForInteractionRequest(BaseModel):
    context: PydanticBaseModelStrippedNonemptyString1 | None = Field(
...
class DynamicBehaviorSetCreateDynamicBehaviorSetRequestInitialVersionChangeToolCandidatesActionToolCallSpec(
    ...
    additional_instruction: PydanticBaseModelStrippedNonemptyString1 = Field(
        ...,
        description="Additional instruction to be supplied to the LLM in addition to the tool's description.",
    )
    ...
    tool_name: PydanticBaseModelStrippedNonemptyString1 = Field(
        ...,
        description='An identifier of the tool that will be displayed in the description of this dynamic behavior set. This could be simply the name of the tool, or one augmented with\nthe context of the dynamic behavior.',
    )
...
class MetricCreateMetricVersionResponse(BaseModel):
    version: int = Field(
        ...,
        description='Numerical version ID for the version just created. For the first version of a metric, this field will be 1.',
        title='Version',
    )
...
class OrganizationCreateAgentRequest(BaseModel):
    agent_name: PydanticBaseModelStrippedNonemptyString2 = Field(
...
class OrganizationCreateServiceHierarchicalStateMachineRequest(BaseModel):
    state_machine_name: PydanticBaseModelStrippedNonemptyString2 = Field(
...
class References1Item(AppliedToService):
    pass


class References1(RootModel[tuple[References1Item, int]]):
    root: tuple[References1Item, int] = Field(..., max_length=2, min_length=2)
...
class OrganizationGetOrganizationResponse(BaseModel):
    ...
    onboarding_instructions: list[str] | None = None
    org_id: str = Field(
    ...
    default_user_preferences: PreferencesOutput | None = Field(
        ...,
    ...
    tenant_id: str | None = Field(
        ...,
        description='The tenant ID of the organization. This field is only populated if the authenticated user has the `Organization:GetOrganizationDetails` permission.',
        title='Tenant Id',
    )
...
class SimulationCreateSimulationPersonaRequestInitialVersion(BaseModel):
    background: PydanticBaseModelStrippedNonemptyString1 = Field(
...
class SimulationCreateSimulationScenarioRequestInitialVersion(BaseModel):
    objective: PydanticBaseModelStrippedNonemptyString1 = Field(
        ..., description='The objective of the simulation scenario.'
    )
    instructions: PydanticBaseModelStrippedNonemptyString1 = Field(
...
class SimulationCreateSimulationUnitTestSetRequest(BaseModel):
    name: PydanticBaseModelStrippedNonemptyString1 = Field(
...
class UnitTestRuns(RootModel[list[UnitTestRunDescriptorInput]]):
...
class ToolCreateToolRequest(BaseModel):
    ...
    description: PydanticBaseModelStrippedNonemptyString1 = Field(
        ..., description='A description of the tool.'
    )
    tags: dict[StrippedNonemptyStringWS, StrippedNonemptyStringWS | None] = Field(
        ..., description='The tags of this tool.', max_length=20, title='Tags'
    )
...
class ToolModifyToolEnvvarsRequestDeleteRequest(BaseModel):
    name: StrippedNonemptyStringAZ = Field(
...
class UserGetUsersResponseUserInstance(BaseModel):
    ...
    nonsensitive_variables: dict[str, str] = Field(
        ...,
        description="The user's nonsensitive variables.",
        title='Nonsensitive Variables',
    )
    ...
    enable_actions_access: bool = Field(
        ...,
        description='Whether the user has access to the actions features.',
        title='Enable Actions Access',
    )


class UserModifyUserVariablesRequestDeleteRequest(BaseModel):
    name: StrippedNonemptyStringAZAZ09 = Field(
...
class WebhookDestinationUpdateWebhookDestinationRequest(BaseModel):
    ...
    accepted_types: list[WebhookType] | None = Field(
        None,
...
class InteractWithConversationParametersQuery(BaseModel):
    ...
    request_audio_config: UserMessageAudioConfig | None = Field(
        None,
...
class SearchDynamicBehaviorSetsParametersQuery(BaseModel):
    query: PydanticBaseModelStrippedNonemptyString1 = Field(
        ...,
...
class CreateMetricVersionParametersQuery(BaseModel):
    version: Version4 | None = Field(
        None,
        description="The version number of the new metric version. If specified, this endpoint throws an error if the next version of the metric in the database doesn't equal to the value of this parameter.",
        title='Version',
    )
...
class GetMetricVersionsParametersQuery(BaseModel):
    version: str | None = Field(
        None,
...
class GetMetricEvaluationResultsParametersQuery(BaseModel):
    ...
    metric_id_and_version: list[str] | None = Field(
        [],
...
class CreateSimulationScenarioVersionParametersQuery(
    CreateSimulationPersonaVersionParametersQuery
):
    pass
...
class APIKeyInstance(BaseModel):
    field_id: str = Field(..., alias='_id', title='Id')
    name: str | None = Field(..., description='The name of the API key.', title='Name')
    org_id: str = Field(..., description='The ID of the organization.', title='Org Id')
    created_at: AwareDatetime = Field(
        ...,
...
class AgentFrameworkInvocationMetadata(
    RootModel[
...
class AnnotationStateInput(BaseModel):
    type: Literal['annotation'] = Field(..., title='Type')
    name: StateOrRefName
    inner_thought: PydanticBaseModelStrippedNonemptyString1
    next_state: StateOrRefName | NextState = Field(..., title='Next State')
...
class CategoricalMetricValueInput(BaseModel):
    ...
    categories: list[PydanticBaseModelStrippedNonemptyString1] = Field(
        ..., max_length=50, min_length=1, title='Categories'
    )
...
class ExitConditionInput(BaseModel):
    description: PydanticBaseModelStrippedNonemptyString1
    next_state: StateOrRefName | NextState = Field(..., title='Next State')


class GenerateToolParamsEvent(
    RootModel[
...
class InjectInstructionActionInput(BaseModel):
    type: Literal['inject-instruction'] = Field(..., title='Type')
    instruction: PydanticBaseModelStrippedNonemptyString1
    overrides_instructions: bool = Field(
        ...,
        description='During injection, whether the original instruction of the state is overriden with this instruction.',
        title='Overrides Instructions',
...
class InvocationStatus(RootModel[SucceededInvocationStatus | FailedInvocationStatus]):
    root: SucceededInvocationStatus | FailedInvocationStatus = Field(
        ..., discriminator='succeeded'
    )
...
class Metric(BaseModel):
    ...
    metric_value_type: MetricValueType = Field(
...
class MetricInstance(BaseModel):
    id: str = Field(..., description='The ID of the metric.', title='Id')
    org_id: str = Field(
        ..., description='The organization ID of the metric.', title='Org Id'
    )
    name: str = Field(..., description='The name of the metric.', title='Name')
    applied_to_services: list[str] = Field(
        ...,
    ...
    is_deleted: bool = Field(
        ..., description='Whether the metric is deleted.', title='Is Deleted'
    )
    created_at: AwareDatetime = Field(
        ..., description='The time when the metric is created.', title='Created At'
    )
    updated_at: AwareDatetime = Field(
        ..., description='The time when the metric is last updated.', title='Updated At'
    )


class MetricValueInput(
    RootModel[NumericalMetricValue | CategoricalMetricValueInput | BooleanMetricValue]
):
    root: NumericalMetricValue | CategoricalMetricValueInput | BooleanMetricValue = (
        Field(..., discriminator='type')
    )


class MetricValueOutput(
    RootModel[BooleanMetricValue | NumericalMetricValue | CategoricalMetricValueOutput]
):
    root: BooleanMetricValue | NumericalMetricValue | CategoricalMetricValueOutput = (
        Field(..., discriminator='type')
    )


class MetricVersionInstance(BaseModel):
    metric_id: str = Field(..., description='The ID of the metric.', title='Metric Id')
    version: int = Field(
        ..., description='The version number of the metric.', title='Version'
    )
    description: str = Field(
        ...,
        description='The description of the metric. This tells the LLM what the metric is and how the metric result should be generated.',
        title='Description',
    )
    metric_value: MetricValueOutput = Field(
        ...,
        description='The type of value that this metric is measuring. The value type cannot be adjusted between versions, but specifiers of the type can.',
    )
    creator: MongoCollectionsMetricVersionMetricVersionUserInfo = Field(
        ..., description='The user who created the metric.'
    )
    created_at: AwareDatetime = Field(
        ...,
        description='The timestamp of when the metric version was created.',
        title='Created At',
    )
...
class PermissionGrantOutput(PermissionGrantInput):
    pass


class PermissionGrantInstance(PermissionGrantInput):
    pass
...
class ReflectionStateInput(BaseModel):
    ...
    name: StateOrRefName
    problem: PydanticBaseModelStrippedNonemptyString1
...
class ReflectionStateOutput(BaseModel):
    ...
    next_state: str | NextState7 = Field(
        ...,
        description="The state to transition to after the inner thought message is generated. If it's a string, the session will transition to a state within this contextual graph. If it's a tuple, the first element\nmust be of the form `{external_contextual_graph_reference_name}.{state_name}` and represents a state in another contextual graph that the session will transition to, and the second element must be a state\nin this contextual graph that the session will transition to after reaching the terminal state of the external graph.",
        title='Next State',
    )
...
class RegularConversationInvocationSource(BaseModel):
    ...
    invocation_metadata: AgentFrameworkInvocationMetadata = Field(
        ..., description='Metadata about the invocation.'
    )


class RelationshipToDeveloperInput(BaseModel):
    ownership: PydanticBaseModelStrippedNonemptyString1
    type: PydanticBaseModelStrippedNonemptyString1
    conversation_visibility: PydanticBaseModelStrippedNonemptyString1
    thought_visibility: PydanticBaseModelStrippedNonemptyString1
...
class ServiceInstance(BaseModel):
    ...
    creator: MongoCollectionsServiceServiceUserInfo = Field(
        ..., description='The user who created the service.'
    )
    updated_by: MongoCollectionsServiceServiceUserInfo = Field(
...
class SimulationPersonaVersion(BaseModel):
    ...
    nonsensitive_user_variables: dict[str, str] = Field(
        ...,
        description="A dictionary of the simulation persona's nonsensitive user variables that are provided to the tools.",
        title='Nonsensitive User Variables',
    )
    sensitive_user_variables: dict[str, str] | None = Field(
        {},
    ...
    creator: (
        MongoCollectionsSimulationPersonaVersionSimulationPersonaVersionUserInfo
    ) = Field(..., description='The user who created this simulation persona version.')
...
class SimulationScenarioVersion(BaseModel):
    ...
    creator: (
        MongoCollectionsSimulationScenarioVersionSimulationScenarioVersionUserInfo
    ) = Field(..., description='The user who created this simulation scenario version.')
...
class TemporaryPermissionGrant(BaseModel):
    ...
    permission_grant: PermissionGrantOutput = Field(
...
class ToolCallStateInput(BaseModel):
    ...
    name: StateOrRefName
    next_state: StateOrRefName | NextState8 = Field(..., title='Next State')
    designated_tool: (
        OrganizationCreateServiceHierarchicalStateMachineVersionRequestToolCallSpec
    )
    ...
    designated_tool_call_objective: PydanticBaseModelStrippedNonemptyString1
    designated_tool_call_context: PydanticBaseModelStrippedNonemptyString1
...
class ToolCallStateOutput(BaseModel):
    type: Literal['tool-call'] = Field(..., title='Type')
    name: str = Field(..., description='The name of this state.', title='Name')
    next_state: str | NextState9 = Field(
        ...,
        description="The state to transition to after the inner thought message is generated. If it's a string, the session will transition to a state within this contextual graph. If it's a tuple, the first element\nmust be of the form `{external_contextual_graph_reference_name}.{state_name}` and represents a state in another contextual graph that the session will transition to, and the second element must be a state\nin this contextual graph that the session will transition to after reaching the terminal state of the external graph.",
        title='Next State',
    )
...
class ToolInstance(BaseModel):
    ...
    creator: MongoCollectionsToolToolUserInfo = Field(
        ..., description='The user who created this tool.'
    )
    updated_by: MongoCollectionsToolToolUserInfo = Field(
...
class ToolVersionInstance(BaseModel):
    ...
    updated_by: MongoCollectionsToolVersionToolVersionUserInfo = Field(
...
class VersionSetInput(BaseModel):
    ...
    llm_model_preferences: dict[str, LLMConfigInput] = Field(
        ..., title='Llm Model Preferences'
    )


class VoiceConfig(BaseModel):
    voice_id: PydanticBaseModelStrippedNonemptyString1
...
class MongoCollectionsDynamicBehaviorSetVersionAction(
    RootModel[InjectInstructionActionOutput | ChangeToolCandidatesActionOutput]
):
    root: InjectInstructionActionOutput | ChangeToolCandidatesActionOutput = Field(
        ..., discriminator='type'
    )


class ServiceConversationAction(
    RootModel[
...
class MetricCreateMetricVersionRequest(BaseModel):
    description: PydanticBaseModelStrippedNonemptyString1 = Field(
        ...,
        description='The description of the metric. This tells the LLM what the metric is and how the metric result should be generated.',
    )
...
class MetricGetMetricVersionsResponse(BaseModel):
    metric_versions: list[MetricVersionInstance] = Field(
        ...,
        description='The list of retrieved metric versions.',
        title='Metric Versions',
    )
    has_more: bool = Field(
        ...,
        description='Whether there are more metric versions that can be retrieved with further pagination.',
        title='Has More',
    )
    continuation_token: int | None = Field(
        ...,
        description='The continuation token to be used to retrieve the next page of metric versions. This is only included if `has_more` is true.',
        title='Continuation Token',
    )
...
class OrganizationCreateOrganizationRequest(BaseModel):
    org_name: PydanticBaseModelStrippedNonemptyString1 = Field(
    ...
    azure_devops_team_name: StrippedNonemptyStringAZ1 = Field(
        ...,
...
class OrganizationGetAgentVersionsResponseAgentInstance(BaseModel):
    ...
    creator: MongoCollectionsAgentAgentUserInfo = Field(
...
class OrganizationGetApiKeysResponse(BaseModel):
    api_keys: list[APIKeyInstance] = Field(
        ..., description='The list of API keys for the organization.', title='Api Keys'
    )


class UserDimensions(RootModel[list[UserDimensionInput]]):
...
class RoleCreateRoleRequest(BaseModel):
    role_name: PydanticBaseModelStrippedNonemptyString2 = Field(
        ...,
...
class RoleCreateTemporaryPermissionGrantRequest(BaseModel):
    ...
    justification: PydanticBaseModelStrippedNonemptyString5 = Field(
...
class RoleModifyRoleRequest(BaseModel):
    ...
    permission_grants: list[PermissionGrantInput] | None = Field(
        None,
...
class ServiceCreateServiceRequest(BaseModel):
    ...
    release_version_set: VersionSetInput | None = Field(
        None,
    ...
    tags: dict[StrippedNonemptyStringWS, StrippedNonemptyStringWS | None] = Field(
        ..., description='The tags of this service.', max_length=20, title='Tags'
    )
...
class SimulationCreateSimulationPersonaRequest(BaseModel):
    ...
    role: PydanticBaseModelStrippedNonemptyString1 = Field(
...
class SimulationCreateSimulationUnitTestRequestSuccessCriterion(BaseModel):
    name: PydanticBaseModelStrippedNonemptyString1
...
class ToolInvokeToolVersionResponse(BaseModel):
    invocation_results: list[InvocationResult] = Field(..., title='Invocation Results')


class ToolModifyToolEnvvarsRequest(BaseModel):
    inserts: list[InsertRequest] | None = Field(
        [], title='Inserts', validate_default=True
    )
    updates: list[UpdateRequest] | None = Field(
        [], title='Updates', validate_default=True
    )
    deletes: list[ToolModifyToolEnvvarsRequestDeleteRequest] | None = Field(
        [], title='Deletes', validate_default=True
    )
...
class UserCreateInvitedUserRequest(BaseModel):
    first_name: PydanticBaseModelStrippedNonemptyString1 = Field(
        ..., description='The first name of the user.'
    )
    last_name: PydanticBaseModelStrippedNonemptyString1 = Field(
    ...
    nonsensitive_user_variables: (
        dict[StrippedNonemptyStringAZAZ09LambdaAt0xffff509bfcc0, str] | None
    ) = Field(
        {},
        description='The nonsensitive user variables to provide to the tool during invocation.',
        max_length=19,
    ...
    sensitive_user_variables: dict[StrippedNonemptyStringAZAZ09, str] | None = Field(
        {},
        description='The sensitive user variables to provide to the tool during invocation.',
        max_length=20,
        title='Sensitive User Variables',
...
class UserModifyUserVariablesRequest(BaseModel):
    upserts: list[UpsertRequest] | None = Field(
        [],
        description='A list of variables to upsert.',
        title='Upserts',
        validate_default=True,
    )
    deletes: list[UserModifyUserVariablesRequestDeleteRequest] | None = Field(
        [],
...
class ActionStateInput(BaseModel):
    type: Literal['action'] = Field(..., title='Type')
    name: StateOrRefName
    objective: PydanticBaseModelStrippedNonemptyString1
...
class CurrentAgentActionEvent(BaseModel):
    ...
    action: ServiceConversationAction = Field(
...
class DynamicBehaviorSetVersion(BaseModel):
    ...
    actions: list[MongoCollectionsDynamicBehaviorSetVersionAction] = Field(
        ..., title='Actions'
    )
    creator: (
        MongoCollectionsDynamicBehaviorSetVersionDynamicBehaviorSetVersionUserInfo
    ) = Field(
        ...,
...
class IdentityInput(BaseModel):
    name: PydanticBaseModelStrippedNonemptyString1
    role: PydanticBaseModelStrippedNonemptyString1
    developed_by: PydanticBaseModelStrippedNonemptyString1
...
class InitialMetricVersion(BaseModel):
    description: str = Field(
        ...,
        description='The description of the metric. This tells the LLM what the metric is and how the metric result should be generated.',
        title='Description',
    )
    metric_value: MetricValueInput = Field(
        ...,
        description='The type of value this metric could take for the initial version of the metric. The value type cannot be adjusted between versions.',
    )
...
class MetricEvaluationResultInstance(BaseModel):
    ...
    metric_version: int = Field(
        ...,
        description='The version of the metric that was evaluated.',
...
class ToolInvocationInstance(BaseModel):
    ...
    invocation_source: InvocationSource = Field(
    ...
    inputs: dict[str, Any] = Field(
        ..., description='The input parameters to the tool.', title='Inputs'
    )
...
class MetricCreateMetricRequest(BaseModel):
    ...
    tags: dict[StrippedNonemptyStringWS, StrippedNonemptyStringWS | None] = Field(
        ..., description='The tags of the metric.', max_length=20, title='Tags'
    )
    initial_version_metric_value: InitialMetricVersion = Field(
        ..., description='The initial version of the metric.'
    )
...
class OrganizationCreateAgentVersionRequest(BaseModel):
    ...
    identity: IdentityInput | None = Field(
...
class OrganizationCreateServiceHierarchicalStateMachineVersionRequest(BaseModel):
    ...
    references: dict[StateOrRefName, References1] = Field(
        ...,
...
class ConversationEvent(
    RootModel[InteractionCompleteEvent | NewMessageEvent | CurrentAgentActionEvent]
):
    root: InteractionCompleteEvent | NewMessageEvent | CurrentAgentActionEvent
...
class ServiceHierarchicalStateMachineInstance(BaseModel):
    ...
    creator: (
        MongoCollectionsServiceHierarchicalStateMachineServiceHierarchicalStateMachineUserInfo
    ) = Field(
    ...
    references: dict[str, References] = Field(
        ...,
...
class ConversationInteractWithConversationResponse(
    RootModel[ConversationEvent | UserMessageAvailableEvent | ErrorEvent]
):
    root: ConversationEvent | UserMessageAvailableEvent | ErrorEvent
