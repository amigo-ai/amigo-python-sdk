...
#   filename:  <stdin>
#   timestamp: 2026-03-01T14:07:12+00:00
...
class APIKey(BaseModel):
    ...
    key_value: bytes | None = Field(
        '',
        description='The encrypted value of the API key. This field is not returned in any API responses and not retrievable.',
        title='Key Value',
    )
...
class ServiceInstance(BaseModel):
    ...
    creator: MongoCollectionsServiceServiceUserInfo | None = Field(
        ..., description='The user who created the service.'
    )
    updated_by: MongoCollectionsServiceServiceUserInfo | None = Field(
...
class SimulationPersonaVersion(BaseModel):
    ...
    creator: (
        MongoCollectionsSimulationPersonaVersionSimulationPersonaVersionUserInfo | None
    ) = Field(None, description='The user who created this simulation persona version.')
...
class SimulationScenarioVersion(BaseModel):
    ...
    creator: (
        ...
        None, description='The user who created this simulation scenario version.'
    )
...
class ToolInstance(BaseModel):
    ...
    creator: MongoCollectionsToolToolUserInfo | None = Field(
        None, description='The user who created this tool.'
    )
    updated_by: MongoCollectionsToolToolUserInfo | None = Field(
        None, description='The user who last updated this tool.'
    )
...
class ToolVersionInstance(BaseModel):
    ...
    updated_by: MongoCollectionsToolVersionToolVersionUserInfo | None = Field(
        None, description='The user who last updated the tool version.'
    )
    deprecated: bool = Field(
        ...,
...
class OrganizationGetAgentVersionsResponseAgentInstance(BaseModel):
    ...
    creator: MongoCollectionsAgentAgentUserInfo | None = Field(
